          ...
          <div className="relative z-10 bg-n-8/95 backdrop-blur-xl rounded-2xl border border-n-6 shadow-xl overflow-hidden">
            ...
            <div className="px-8 pt-8 pb-6 border-b border-n-6">
              ...
              <div className="text-center">
                <h1 className="h1 mb-2 text-3xl">Welcome Back</h1>
            ...
            <div className="px-8 py-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label htmlFor="password" className="block text-n-1 text-sm font-medium">
                      Password
                    </label>
                    <Link to="/forgot-password" className="text-xs text-color-1 hover:text-color-1/80 font-medium transition-colors">
                      Forgot?
                    </Link>
                  </div>
                  <div className="relative">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-4 h-4 rounded border-n-6 bg-n-7 text-color-1 focus:ring-1 focus:ring-color-1/20 focus:ring-offset-0 cursor-pointer"
                  />
                  <label htmlFor="rememberMe" className="ml-2 text-sm text-n-2 cursor-pointer">
                    Remember me
                  </label>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-n-6 text-center">
                <p className="text-sm text-n-3">
                  ...
                  <Link to="/signup" className="text-color-1 hover:text-color-1/80 font-semibold transition-colors">
                    Sign up
                  </Link>
                </p>
              </div>
